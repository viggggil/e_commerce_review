...
func (x *SyncTodoRequest) Reset() {
	*x = SyncTodoRequest{}
	mi := &file_api_todo_v1_todo_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SyncTodoRequest) Descriptor() ([]byte, []int) {
	return file_api_todo_v1_todo_proto_rawDescGZIP(), []int{8}
}
...
func (x *TodoEvent) Reset() {
	*x = TodoEvent{}
	mi := &file_api_todo_v1_todo_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TodoEvent) Descriptor() ([]byte, []int) {
	return file_api_todo_v1_todo_proto_rawDescGZIP(), []int{9}
}
...
const file_api_todo_v1_todo_proto_rawDesc = "" +
	"\n" +
	"\x16api/todo/v1/todo.proto\x12\atodo.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xde\x01\n" +
	"\x04Todo\x12\x0e\n" +
...
var file_api_todo_v1_todo_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
